...
namespace MCLProyecto.Modelo
{
    public class ConexionBD
    {
        ...
        public void InsertarDiagnostico(String codigo, string fecha, String rut_p, String rut_a)
        {
            cmd = new MySqlCommand(String.Format("INSERT INTO diagnostico(codigo,fecha,rut_p,rut_a) VALUE ('" + codigo + "','" + fecha + "','" + rut_p + "','" + rut_a + "')"), conn);
            cmd.ExecuteNonQuery();
        }

        public void InsertarResultadosAlumnoDiagnostico(String codigo, string fecha, String rut_p, String rut_a, int h1_c, int h1_i, int h2_c, int h2_i, String nivel_logro_h1, String nivel_logro_h2, String modulo) //Se insertan datos de diagnostico
        {
            cmd = new MySqlCommand(String.Format("INSERT INTO diagnostico(codigo,fecha,rut_p,rut_a) VALUE ('" + codigo + "','" + fecha + "','" + rut_p + "','" + rut_a + "')"), conn);
            cmd.ExecuteNonQuery();
            Console.WriteLine("BD:");
            Console.WriteLine("H1C: " + h1_c);
            Console.WriteLine("H1I: " + h1_i);
            Console.WriteLine("H2C: " + h2_c);
            Console.WriteLine("H2I: " + h2_i);
        ...
        public Boolean ComprobarRegistroAlumno(String rut, string clave)
        {
        ...
        public Boolean ComprobarRegistroProfesor(String rut, string clave)
        {
            cmd = new MySqlCommand(String.Format("SELECT rut,clave FROM profesor where rut='" + rut + "' and clave='" + clave + "'"), conn);
            MySqlDataReader reader = cmd.ExecuteReader();
            return reader.Read(); ;
        }

        public Boolean existeRutAlumno(String rut)
        {
            cmd = new MySqlCommand(String.Format("SELECT rut FROM alumno where rut='" + rut + "'"), conn);
            MySqlDataReader reader = cmd.ExecuteReader();
            return reader.Read(); ;
        }

        public Boolean existeRutProfesor(String rut)
        {
            cmd = new MySqlCommand(String.Format("SELECT rut FROM profesor where rut='" + rut + "'"), conn);
            MySqlDataReader reader = cmd.ExecuteReader();
            return reader.Read(); ;
        }
